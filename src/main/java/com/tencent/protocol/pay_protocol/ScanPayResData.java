...
public class ScanPayResData {
    ...
    public static ScanPayResData toObject(Map<String,Object> map){
    	
    	ScanPayResData result = new ScanPayResData();
        ...
        for (Field field : fields) {
            ...
            try {
            	...
            	if (map.get(field.getName()) != null){
            		Method method =  result.getClass().getMethod("set"+upperHeadChar(field.getName()), field.getType());
            		if (field.getType().equals(Integer.class)){
            			Integer a = Integer.parseInt(map.get(field.getName()).toString());
            			method.invoke(result, a);
            		}else{
	...
	private static String upperHeadChar(String name) {
		...
		String out = head.toUpperCase() + name.substring(1, name.length());
		return out;
	}
}
