 ...
 * 请求被扫支付API需要提交的数据
 */
public class WxAppPayReqData {
	public static void main(String[] args) {
		System.out.println(ZcJsonKit.nonEmptyMapper().toJson(BeanMapper.map(new WxAppPayReqData(), Map.class)));
	}
	public WxAppPayReqData() {
	}
    //每个字段具体的意思请查看API文档
     ...
     */
    public WxAppPayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag){
