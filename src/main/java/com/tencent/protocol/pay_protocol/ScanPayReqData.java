 ...
 * 请求被扫支付API需要提交的数据
 */
public class ScanPayReqData implements Cloneable{
	public static void main(String[] args) {
		System.out.println(ZcJsonKit.nonEmptyMapper().toJson(BeanMapper.map(new ScanPayReqData(), Map.class)));
	}
	public ScanPayReqData() {
	}
	@Override  
	public ScanPayReqData clone() {  
		ScanPayReqData o = null;  
	    try {  
	        o = (ScanPayReqData) super.clone();  
