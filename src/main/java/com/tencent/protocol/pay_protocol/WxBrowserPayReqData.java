...
import xyz.nesting.common.util.BeanMapper;

/**
 * 请求被扫支付API需要提交的数据
 */
public class WxBrowserPayReqData {
	public static void main(String[] args) {
		System.out.println(ZcJsonKit.nonEmptyMapper().toJson(BeanMapper.map(new WxBrowserPayReqData(), Map.class)));
	}
	public WxBrowserPayReqData() {
	}
    //每个字段具体的意思请查看API文档
    ...
    @Min(value=0,message="total_fee需大于零")
     ...
     */
    public WxBrowserPayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag){
