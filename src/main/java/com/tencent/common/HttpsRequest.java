...
public class HttpsRequest implements IServiceRequest {
	...
	private String certLocalPath = Configure.getCertLocalPath();
	
	private String certPassword = Configure.getCertPassword();
	...
	public HttpsRequest(String certLocalPath, String certPassword) throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException,
			KeyStoreException, IOException {
	...
	public String sendPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException,
		...
		XStream xStreamForRequestPostData = new XStream(new DomDriver("ISO8859-1", new XmlFriendlyNameCoder("-_", "_")));

		// 将要提交给API的数据对象转换成XML格式数据Post给API
		String postDataXML = xStreamForRequestPostData.toXML(xmlObj);
//		postDataXML = new String(postDataXML.getBytes(),"ISO8859-1");
		...
		try {
			...
			Util.log("executing response" + result);
