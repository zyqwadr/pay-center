...
public class AlipaySubmit {
     ...
     */
    public static String buildRequestApp(Map<String, String> sParaTemp) throws UnsupportedEncodingException {
        //待请求参数数组
    	String data=AlipayCore.createLinkStringWishQuote(sParaTemp);
    	//String data=getOrderInfo("测试的商品", "该测试商品的详细描述", "0.01");
    ...
    public static String buildRequestUrl(Map<String, String> sParaTemp) {
        ...
        sbUrl.append(ALIPAY_GATEWAY_NEW);
